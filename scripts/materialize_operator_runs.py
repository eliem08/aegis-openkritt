...
def main() -> None:
    ...
    if mobsf_summary_path.is_file():
        ...
        create_operator_run(
            ...
            binary_path="docker:opensecurity/mobile-security-framework-mobsf:v4.3.2",
    ...
    if gau_summary_path.is_file():
        ...
        create_operator_run(
            ...
            backend_package="gau",
            binary_path=gau_summary["binary"]["path"],
            coverage_state=ArsenalCoverageState.EXECUTED_PASS,
    ...
    if subf_summary_path.is_file():
        ...
        create_operator_run(
            ...
            binary_path=subf_summary["binary"]["path"],
            coverage_state=ArsenalCoverageState.EXECUTED_PASS,
