"""Default Aegis Jarvis agent council.

This module composes specialized reasoning agents. It does not grant them direct
execution authority; every proposed action remains subject to ProposalPolicy.
"""
...
def default_agents(*, human_hour_cost_usd: float = 0.0) -> tuple[SecurityAgent, ...]:
    """Return the default specialist council used by the Jarvis orchestrator."""
    specialists: tuple[SecurityAgent, ...] = (
        ...
        MemoryTriggeredAgent(
            ...
            "Prioritize affected dependencies only when version, call, and reachability evidence support impact.",
            0.65,
        ),
        MemoryTriggeredAgent(
            AgentRole.CLOUD,
        ...
        MemoryTriggeredAgent(
            ...
            "Inspect recent security-sensitive changes for regressions, incomplete fixes, and unexplored siblings.",
            0.89,
        ),
        HypothesisAgent(),
        InvariantAgent(),
