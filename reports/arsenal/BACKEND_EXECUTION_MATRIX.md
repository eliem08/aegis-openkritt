...
Git SHA: `d9351a37c956b7be303530dcab9dfd707255476a`
Arsenal image: ``
...
| `azurehound/cloud-lab` | AzureHound | `arsenal-cloud-lab` | `` | True | True | **EXECUTED_PASS** | asset:azurehound/azure-entra-relationship-collection |
...
| `class-dump/macos-cli` | class-dump | `arsenal-macos-ios` | `` | True | True | **EXECUTED_PASS** | asset:class-dump/objective-c-interface-recovery |
...
| `firmadyne/qemu-lab` | Firmadyne | `arsenal-firmware` | `` | True | True | **EXECUTED_PASS** | asset:firmadyne/firmware-emulation-fallback |
| `firmae/qemu-lab` | FirmAE | `arsenal-firmware` | `` | True | True | **EXECUTED_PASS** | asset:firmae/firmware-emulation |
...
| `frida/device-cli` | Frida | `arsenal-android` | `` | True | True | **EXECUTED_PASS** | asset:frida/android-runtime-instrumentation<br>asset:frida/ios-runtime-instrumentation |
...
| `gau/network-lab` | gau | `arsenal-network-lab` | `` | True | True | **EXECUTED_PASS** | adapter:gau/passive-discovery |
...
| `mobsf/container` | MobSF | `arsenal-android` | `` | True | True | **EXECUTED_PASS** | asset:mobsf/rest-static-analysis |
...
| `objection/android-lab` | objection | `arsenal-android` | `` | True | True | **EXECUTED_PASS** | asset:objection/android-runtime-exploration<br>asset:objection/ios-runtime-exploration |
...
| `otool/macos-cli` | otool | `arsenal-macos-ios` | `` | True | True | **EXECUTED_PASS** | asset:otool/ios-macos-load-command-analysis |
...
| `prowler/cloud-lab` | Prowler | `arsenal-cloud-lab` | `` | True | True | **EXECUTED_PASS** | asset:prowler/aws-security-posture<br>asset:prowler/azure-security-posture |
...
| `roadrecon/cloud-lab` | ROADtools | `arsenal-cloud-lab` | `` | True | True | **EXECUTED_PASS** | asset:roadtools/entra-identity-analysis |
...
| `scoutsuite/cloud-cli` | ScoutSuite | `arsenal-cloud-lab` | `` | True | True | **EXECUTED_PASS** | asset:scoutsuite/aws-attack-surface-audit<br>asset:scoutsuite/azure-attack-surface-audit |
...
| `subfinder/network-lab` | subfinder | `arsenal-network-lab` | `` | True | True | **EXECUTED_PASS** | adapter:subfinder/passive-discovery<br>asset:subfinder/passive-subdomain-enumeration |
...
| `aegis/aegis-agent-permission-audit` | aegis-agent-permission-audit | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset:aegis-agent-permission-audit/agent-tool-permission-analysis |
| `aegis/aegis-artifact-diff` | aegis-artifact-diff | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset:aegis-artifact-diff/authorized-mobile-release-diff |
| `aegis/aegis-asar` | aegis-asar | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset-lane:bundle-unpack |
| `aegis/aegis-asset-classifier` | aegis-asset-classifier | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset:aegis-asset-classifier/deterministic-asset-classification |
| `aegis/aegis-asset-triage` | aegis-asset-triage | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset-lane:asset-triage |
| `aegis/aegis-authz-matrix` | aegis-authz-matrix | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset-lane:authorization-matrix |
| `aegis/aegis-binary-triage` | aegis-binary-triage | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset-lane:binary-triage |
| `aegis/aegis-bola-probe` | aegis-bola-probe | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset-lane:object-reference-probe |
| `aegis/aegis-contract-patterns` | aegis-contract-patterns | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset-lane:contract-pattern-review |
| `aegis/aegis-firmware-arch` | aegis-firmware-arch | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset:aegis-firmware-arch/firmware-architecture-detection |
| `aegis/aegis-github-org` | aegis-github-org | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset:aegis-github-org/github-org-authorized-inventory<br>asset:aegis-github-org/github-org-public-inventory |
| `aegis/aegis-gitlab-group` | aegis-gitlab-group | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset:aegis-gitlab-group/gitlab-group-authorized-inventory<br>asset:aegis-gitlab-group/gitlab-group-public-inventory |
| `aegis/aegis-llm-lab` | aegis-llm-lab | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset-lane:prompt-injection-suite<br>asset-lane:system-prompt-extraction<br>asset-lane:tool-abuse-chain |
| `aegis/aegis-memory-poisoning` | aegis-memory-poisoning | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset:aegis-memory-poisoning/agent-memory-poisoning-regression |
| `aegis/aegis-model-provenance` | aegis-model-provenance | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset:aegis-model-provenance/model-provenance-and-hash-ledger |
| `aegis/aegis-openapi-parser` | aegis-openapi-parser | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset-lane:mass-assignment<br>asset-lane:openapi-ingest |
| `aegis/aegis-output-oracle` | aegis-output-oracle | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset-lane:output-handling-review |
| `aegis/aegis-package-registry` | aegis-package-registry | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset:aegis-package-registry/public-package-metadata |
| `aegis/aegis-policy-parser` | aegis-policy-parser | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset-lane:iam-policy-review |
| `aegis/aegis-rag-boundary` | aegis-rag-boundary | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset:aegis-rag-boundary/rag-retrieval-trust-analysis |
| `aegis/aegis-store-metadata` | aegis-store-metadata | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset:aegis-store-metadata/public-listing-metadata |
| `aegis/aegis-strings` | aegis-strings | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset-lane:dependency-extraction<br>asset-lane:embedded-secret-scan |
| `aegis/crt.sh` | crt.sh | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset-lane:passive-certificate-transparency |
| `aegis/stdlib-http` | stdlib-http | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset-lane:metadata-endpoint-exposure<br>asset-lane:public-blob-review<br>asset-lane:public-bucket-review<br>asset-lane:rate-limit-check<br>asset-lane:security-headers<br>asset-lane:virtual-host-discovery |
| `aegis/stdlib-resolver` | stdlib-resolver | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset-lane:dns-enumeration<br>asset-lane:subdomain-takeover |
| `aegis/stdlib-ssl` | stdlib-ssl | `arsenal-core` | `aegis-internal` | True | True | **EXECUTED_PASS** | asset-lane:tls-inspection |
